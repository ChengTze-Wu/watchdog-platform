...
export default function Sidebar() {
  ...
  return (
    <div className="grid grid-rows-[auto,1fr,auto] w-64 min-h-screen p-3 border-r dark:border-zinc-700">
        ...
        {sidebarItems.map((item, index) => (
          <Link
            ...
            className={clsx(
              ...
              item.href.startsWith(pathname) && "bg-zinc-200 dark:bg-zinc-800"
            )}
          >
